...
## Technology Stack
- **AI Engine**: Google Gemini (via Replit AI Integrations) for natural language understanding and empathetic dialogue.
- **Frontend**: React & Tailwind CSS for a calming, accessible user interface.
- **Backend**: Node.js & Express.
- **Database**: PostgreSQL for managing conversations and resources.
...
## Key Features
1. **AI Chat Interface**: Conversations with context awareness.
2. **Emergency Detection**: Prominent display of emergency helplines.
3. **Resource Directory**: Categorized list of mental health services.

## Future Scope
- Integration with campus appointment systems.
